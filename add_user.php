...
<?php include_once('./includes/sidebar.php'); ?>
    <div  data-width="400" style="display: block;">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group form-md-line-input form-md-floating-label">
                            ...
                            <input type="text" id="name" name="name" class="form-control input-sm" data-required="true" value="">
                        ...
                        <div class="form-group form-md-line-input form-md-floating-label">
                            ...
                            <input type="text" id="username" name="username" class="form-control input-sm" data-required="true" value="">
                            <label for="username" class="control-label">Username</label>
                            <span class="form-control-focus"> </span>
                        </div>
                        <div class="form-group form-md-line-input form-md-floating-label">

                            <input type="email" id="email" name="email" class="form-control input-sm" data-parsley-type="email" data-required="true" value="">
                            <label for="email" class="control-label">Email</label>
                            <span class="form-control-focus"> </span>
                        </div>
                        <div class="form-group form-md-line-input form-md-floating-label">

                            <input type="text" id="password" name="password" class="form-control input-sm" data-required="true" value="">
